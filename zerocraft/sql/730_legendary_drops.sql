...
FROM zc_leg l JOIN creature_template ct ON ct.name = l.boss
...
LEFT JOIN creature_loot_template t ON t.Item = l.item AND t.Reference = 0 AND t.Comment = CONCAT('ZeroCraft legendary - ', l.boss)
