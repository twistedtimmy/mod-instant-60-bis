...
DROP TEMPORARY TABLE IF EXISTS zc_raid_copy;
CREATE TEMPORARY TABLE zc_raid_copy SELECT lootid FROM zc_raid;
INSERT IGNORE INTO zc_raid SELECT d.lootid FROM creature_template b JOIN zc_raid_copy r ON r.lootid = b.lootid
