...
DROP TEMPORARY TABLE IF EXISTS zc_raid2_copy;
CREATE TEMPORARY TABLE zc_raid2_copy SELECT lootid FROM zc_raid2;
INSERT IGNORE INTO zc_raid2 SELECT d.lootid FROM creature_template b JOIN zc_raid2_copy r ON r.lootid = b.lootid
